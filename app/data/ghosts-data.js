...
export const ghosts = [
    {
        ...
        strength: "Banshees will weaken their target before striking.",
        weakness: "Banshees can sometimes be heard screaming with a parabolic microphone."
    ...
    },
    {
        ...
        strength: "The Dayan gains strength to protect herself if people 'dances' too close to her.",
        weakness: "The Dayan loses strength if people close to her stand still."

    },
    {
        name: "Demon",
        evidences: ["Freezing Temperatures", "Ghost Writing", "Ultraviolet"],
    ...
    {
        name: "Deogen",
        evidences: ["Ghost Writing", "D.O.T.S Projector", "Spirit Box"],
    ...
    {
        name: "Hantu",
        evidences: ["Ultraviolet", "Freezing Temperatures", "Ghost Orb"],
    ...
    {
        name: "Mare",
        evidences: ["Ghost Writing", "Ghost Orb", "Spirit Box"],
    ...
    {
        name: "Moroi",
        evidences: ["Ghost Writing", "Freezing Temperatures", "Spirit Box"],
    ...
    {
        name: "Obambo",
        evidences: ["Ultraviolet", "Ghost Writing", "D.O.T.S Projector"],
    ...
    {
        name: "Onryo",
        evidences: ["Ghost Orb", "Freezing Temperatures", "Spirit Box"],
    ...
    {
        name: "Phantom",
        evidences: ["Ultraviolet", "D.O.T.S Projector", "Spirit Box"],
    ...
    {
        name: "Poltergeist",
        evidences: ["Ultraviolet", "Ghost Writing", "Spirit Box"],
    ...
    {
        name: "Revenant",
        evidences: ["Ghost Writing", "Freezing Temperatures", "Ghost Orb"],
    ...
    {
        name: "Thaye",
        evidences: ["Ghost Writing", "D.O.T.S Projector", "Ghost Orb"],
    ...
    {
        name: "The Mimic",
        evidences: ["Ultraviolet", "Freezing Temperatures", "Spirit Box"],
    ...
    {
        name: "Yokai",
        evidences: ["D.O.T.S Projector", "Spirit Box", "Ghost Orb"],
    ...
    {
        name: "Yurei",
        evidences: ["Freezing Temperatures", "Ghost Orb", "D.O.T.S Projector"],
